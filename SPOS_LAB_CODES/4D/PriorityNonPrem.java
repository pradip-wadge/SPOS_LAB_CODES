...
class PriorityNonPrem
{
    ...
    void getProcessData(Scanner input) 
    {
        ...
        for (int i = 0; i < numberOfProcess; i++) 
        {
            ...
            System.out.print("Enter the burst time   for Process - p" + (i) + " : ");
            burstTime[i] = input.nextInt();
            System.out.print("Enter the arrival time for Process - p" + (i) + " : ");
            arrivalTime[i] = input.nextInt();
            System.out.print("Enter the priority     for Process - p" + (i) + " : ");
